...
////project details
define('_project_name_', "SMARTCOM DESIGN AND STUDIO");//this is used in 
define('_project_name_for_web_title_', "SMARTCOM DESIGN AND STUDIO"); # to display
define('_project_complete_name_', "SMARTCOM DESIGN AND STUDIO"); # to display
define('_brand_name_', "SMARTCOM");//need in left_nav
define('_summernote_', "");
...
// define('_project_contact_whatsapp_message_', "Welcome to SMARTCOM DESIGN AND STUDIO");
// define('_project_email_', "info@smartcom.in");

///email api details
define('__fromemail__', "info@smartcom.in");
define('__from_email__', "info@smartcom.in");
...
// define('__adminemail__', "info@smartcom.in");
// define('__adminsms__', "919392199595");  // for Register

define('_project_web_', "www.smartcom.in");
define('_mainsite_hostname_', "smartcom.in");

// define('_SMS_BRAND_', "smartcom.in");
...
// define('_INSTAGRAM_', "https://instagram.com/smartcom.rythusevakendram?utm_source=qr");
// define('_TWITTER_', "");
// define('_YOUTUBE_', "https://youtube.com/@smartcom_farmer?si=G2mHlloY4qTbuUsd");
// define('_PINTEREST_', "");
// define('_LINKEDIN_', "");
